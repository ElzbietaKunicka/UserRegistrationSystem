...
namespace UserRegistrationSystem.Controllers
{
    ...
    public class PersonalInformationsController : ControllerBase
    {
        ...
        public PersonalInformationsController(IPersonalInformationList 
        ...
        [Authorize(AuthenticationSchemes = 
            ...
            Roles = "User, Admin")]
        [HttpPost]
        public ActionResult PostItem([FromBody] PersonalInformationDto 
            personalInformationToAdd)
        {
            ...
            {
                _personalInformationList
                    .AddNewPersonalInformation(currentUserIdInt, 
                    personalInformationToAdd);
                return Ok();
            }
        ...
        [Authorize(AuthenticationSchemes = JwtBearerDefaults
            .AuthenticationScheme, Roles = "User, Admin")]
        [HttpPut]
        public void UpdateItem([FromBody] PersonalInformationDto 
            personalInformationToAdd)
        {
            var userIdStr = User.Claims
                .FirstOrDefault(c => c.Type == ClaimTypes.NameIdentifier)
                .Value;
            var currentUserIdInt = int.Parse(userIdStr);
            _personalInformationList.UpdatePersonalInformation(currentUserIdInt, 
                personalInformationToAdd);
        }
        ...
        public int? GetPersonalInformationIdByCurrentUserId()
        {
            var userIdStr = User.Claims
                ...
                .Value;
            var currentUserIdInt = int.Parse(userIdStr);
            return _personalInformationList
                .getPersonalInformationIdByCurrentUser(currentUserIdInt);
        }
        ...
        public PersonalInformation GetAllInfoAboutCurrentUser()
        {
            ...
            var currentUserIdInt = int.Parse(userIdStr);
            return _personalInformationList
                .GetAllInfoAboutCurrentUser(currentUserIdInt);
        }
        ...
        public string GetCurrentUserName()
        {
            ...
            var currentUserIdInt = int.Parse(userIdStr);
            return _personalInformationList
                .GetCurrentUserName(currentUserIdInt);
        }
        ...
        [Authorize(AuthenticationSchemes = JwtBearerDefaults
            .AuthenticationScheme, Roles = "Admin")]
        [HttpDelete("{id}")]
